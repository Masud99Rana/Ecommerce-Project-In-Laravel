...
# Ecommerce Project ( Cart Feature ) in laravel
> **Note:** This repository contains the core code of a simple Ecommerce Project ( Mainly, Payment Gateway, Cart Feature, SMS system )
...
## About The Project
E-commerce is the activity of electronically buying or selling of products on online services or over the Internet. In this project, I have practiced how to develop a real-world, Ecommerce Cart System along with Payment Gateway, SMS system.
